...
class EmployeeInfoExcelReport(models.TransientModel):
    ...
    def generated_excel_report(self, record):
        ...
        style0 = xlwt.easyxf('font: name Times New Roman bold on; align: horiz left; borders: top thin; pattern: pattern solid, fore_colour white', num_format_str='#,##0.00')
        style1 = xlwt.easyxf('font:bold True, color Yellow , height 400;  borders:top thin; align: horiz center; pattern: pattern solid, fore_colour blue;', num_format_str='#,##0.00')
        style2 = xlwt.easyxf('font:bold True, color White , height 440;  borders:top thin; align: horiz center; pattern: pattern solid, fore_colour  gold;', num_format_str='#,##0.00')
        styletitle = xlwt.easyxf(
            'font:bold True, color White, height 240;  borders: top thin; align: horiz center; pattern: pattern solid, fore_colour gold;',
            num_format_str='#,##0.00')
